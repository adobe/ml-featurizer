...
object AdditionFeaturizerExample {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder().appName("AdditionFeaturizer").master("local").getOrCreate()
    ...
    val featurizer = new AdditionFeaturizer()
