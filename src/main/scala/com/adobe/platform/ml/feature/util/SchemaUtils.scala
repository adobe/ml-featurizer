...
/**
  * Need to find a way to extends this from Spark library rather than include it directly.
  * Since its a private utils package, include it directly here for now.
  * Utils for handling schemas.
  */
private object SchemaUtils {
